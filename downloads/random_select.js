// Generated by dart2js (fast startup emitter, strong), the Dart to JavaScript compiler version: 2.8.0-edge.9983424a3c50c623730fd43b4ce263df660eb455.
...
(function dartProgram() {
  ...
  H = {JS_CONST: function JS_CONST() {
    ...
    _installSpecializedIsTest: function(object) {
      ...
      if (H.isStrongTopType(testRti) || testRti === type$.Object) {
        isFn = H._isTop;
  ...
  U = {
    main: function() {
      var t1 = J.get$onClick$x(document.querySelector("#Rsubmit")),
        t2 = t1.$ti,
        t3 = t2._eval$1("~(1)")._check(new U.main_closure());
      type$.void_Function._check(null);
    ...
    randomSelect: function() {
      var t1 = $.$get$output();
      t1.toString;
      C.TextAreaElement_methods.setInnerHtml$1(t1, "");
      t1 = $.$get$studListUrl();
      if (t1.value !== "")
        $.grpList = t1.value;
      else
      ...
      t1 = $.$get$numOfStud();
      if (t1.value !== "")
        $.num0 = P.int_parse(t1.value);
      else
        $.num0 = 2;
      W.HttpRequest_getString($.grpList).then$1$1(new U.randomSelect_closure(), type$.Null);
    },
  ...
  U.randomSelect_closure.prototype = {
    call$1: function(resp) {
      var studList, t1, i, t2, i0, j;
      H._checkStringNullable(resp);
      resp.toString;
      studList = type$.List_dynamic._check(C.C_JsonCodec.decode$2$reviver(0, H.stringReplaceAllUnchecked(resp, "'", ""), null));
...
;
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "studListUrl", "$get$studListUrl", function() {
      return H.findType("SelectElement")._check(W.querySelector("#RstudListUrl"));
    });
    _lazy($, "numOfStud", "$get$numOfStud", function() {
      return H.findType("InputElement")._check(W.querySelector("#RnumOfStud"));
    });
    _lazy($, "output", "$get$output", function() {
      return H.findType("TextAreaElement")._check(W.querySelector("#Routput"));
    });
  })();
...
//# sourceMappingURL=random_select.js.map
